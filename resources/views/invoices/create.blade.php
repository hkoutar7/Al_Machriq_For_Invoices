        ...
        <form action="{{route('invoices.store')}}" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="row row-sm" style="width : 100%">
                ...
                <div class="col-lg">
                    ...
                    <input id='invoice_number' name="invoice_number" class="form-control" placeholder="المرجو ادخال رقم الفاتورة" type="text" value="{{old('invoice_number')}}">
                </div>
                <div class="col-lg mg-t-10 mg-lg-t-0">
                    ...
                    <div>
                        <div class="input-group ">
                            ...
                            <input id="invoice_date" name='invoice_date' class="form-control fc-datepicker" placeholder="MM/DD/YYYY" type="text" value="{{ old('invoice_date') ? old('invoice_date') : date('Y-m-d') }}">
                ...
                <div class="col-lg mg-t-10 mg-lg-t-0">
                    ...
                    <div>
                        <div class="input-group ">
                            ...
                            <input id="due_date" name="due_date" class="form-control fc-datepicker" placeholder="MM/DD/YYYY" type="text" value="{{old('due_date')}}">
                        </div>
                    </div>
                </div>
            ...
            <div class="row row-sm mt-3" style="width : 100%">
                ...
                <div class="col-lg">
                    ...
                    <input id='amount_collection' name="amount_collection" value="{{ old("amount_collection") ? old("amount_collection") : 0  }}" class="form-control" placeholder="المرجو ادخال مبلغ التحصيل" type="number" min="0">
                </div>
            ...
            <div class="row row-sm mt-3" style="width : 100%">
                <div class="col-lg">
                    ...
                    <input id='amount_commission' name="amount_commission" value="{{ old("amount_commission") ? old("amount_commission") : 0  }}" class="form-control" placeholder="المرجو ادخال مبلغ العمولة" type="number" min="0" required>
                </div>

                <div class="col-lg">
                    <label for="discount">الخصم</label>
                    <input id='discount' name="discount" value="{{ old("discount") ? old("discount") : 0  }}" class="form-control" placeholder="المرجو ادخال الخصم" type="number" min="0" required>
                </div>
            ...
            <div class="row row-sm mt-3" style="width : 100%">
                <div class="col-lg">
                    ...
                    <input id='value_vat' name="value_vat" value="{{ old("value_vat") ? old("value_vat") : 0  }}" class="form-control" placeholder="املئ المعلومات اعلاه" type=" text" min="0" readonly>
                </div>

                <div class="col-lg">
                    <label for="total">الاجمالي الشامل للضريبة</label>
                    <input id='total' name="total" value="{{ old("total") ? old("total") : 0  }}" class="form-control" placeholder="املئ المعلومات اعلاه" type="number" min="0" readonly>
                </div>
            </div>

            <div class="row  row-sm mt-5 pr-2">
                <label for="note">ملاحظات <span style="color: tomato">(اختياري)</span></label>
                <textarea id="note" name="note" class="form-control" placeholder="ادخل ماحظات" rows="3">{{ old('note', '') }}</textarea>
            </div>

            <div class="mt-5">
                <p class="text-danger"><span>الصيغ المناسبة</span> .jpg .jpeg .png .pdf .xmls</p>
                <label for="media">المرفقات</label>
                <input id="media" name="media" type="file" class="dropify" accept=".pdf,.jpg, .png, image/jpeg, image/png">
            </div>
...
{{-- my Scripts  --}}
<script src="{{asset('script\invoice\rateVal.js')}}"></script>
