...
<div class="breadcrumb-header justify-content-between">
    ...
    <div class="my-auto">
        <div class="d-flex">
            <a href="{{ route("invoices.index") }}" class="content-title mb-0 my-auto"> الفواتير</a><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة الفواتير</span>
        </div>
    </div>
</div>
<!-- End breadcrumb -->
...
<div class="col-xl-12">
    <div class="card mg-b-20">
        ...
        <div>
            <div style="display: flex; align-items: center; justify-content: flex-end; gap: 14px; margin-left: 40px;">

                @can('add-invoice')
                <a href="{{ route('invoices.create') }}" class="btn btn-outline-primary" style=" width: 138px;">
                    <i style="font-size: 17px;transform: translate(4px ,1px);" class="fa fa-plus"></i> اضافة فاتورة
                </a>
                @endcan

                @can('exportXML-invoice')
                <a href="{{ route('invoicesDetails.export') }}" class="btn btn-outline-primary" style=" width: 138px;">
                    <i style="font-size: 17px;transform: translate(4px ,1px);" class="fa fa-file-excel"></i> تصدير اكسل
                </a>
                @endcan
            </div>
        </div>
