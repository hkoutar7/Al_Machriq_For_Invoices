...
@section('title'," قائمة الغير الفواتير المدفوعة")
...
<div class="breadcrumb-header justify-content-between">
    ...
    <div class="my-auto">
        <div class="d-flex">
            <a href="{{ route("invoices.index") }}" class="content-title mb-0 my-auto"> الفواتير</a><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة الفواتير الغير المدفوعة</span>
        </div>
    </div>
</div>
<!-- End breadcrumb -->
