        ...
        <div class="main-header-right">
                    ...
                    <div class="dropdown  nav-itemd-none d-md-flex">
                        <a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
                            <span class="avatar country-Flag mr-0 align-self-center bg-transparent">
                                <img src="{{asset('myImages/saudi.png')}}" alt="img" style="width: 2.5rem; height :auto">
                            </span>
                            <div class="my-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                            <a href="#" class="dropdown-item d-flex ">
                                ...
                                <div class="d-flex">
                                    <span class="mt-2">انجليزي</span>
                                </div>
                            </a>
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar  ml-3 align-self-center bg-transparent"><img src="{{URL::asset('myImages/japan.png')}}" alt="img"></span>
                                <div class="d-flex">
                                    <span class="mt-2">ياباني</span>
                                </div>
                            </a>
                            <a href="#" class="dropdown-item d-flex">
                                <span class="avatar ml-3 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/russia_flag.jpg')}}" alt="img"></span>
                                <div class="d-flex">
                                    <span class="mt-2">روسي</span>
                                </div>
                            </a>
                        </div>
                    </div>
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown nav-item main-header-message ">
                    ...
                    <a class="new nav-link" href="#" style="display: flex;align-items: center; justify-content: center;">
                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex" style="justify-content: space-between">
                                <h6 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold"> الإشعارات الغير مقروؤة</h6>
                                <a href=" {{ route('notifications.readAll') }}  ">
                                    <span class="badge badge-pill badge-warning mr-auto my-auto float-left">قرئ الكل</span>
                                </a>
                            </div>
                            <div id="countUnreadInvoices" class="d-flex" style="justify-content: space-between">
                                <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 "> عدد الاشعارات {{ Auth::User()->unreadNotifications ()->count() }} </p>
                                <a href=" {{ route('notifications.DeleteAll') }}  ">
                                    <span class="badge badge-pill badge-danger mr-auto my-auto float-left">حدف الكل</span>
                                </a>
                            </div>
                        </div>
                        <div class="main-message-list chat-scroll" id="UnreadInvoices">
                            ...
                            <a href=" {{ route("notifications.show",$notification->data["invoiceId"]) }} " class="p-3 d-flex border-bottom">
                                ...
                                <div class="wd-90p">
                                    ...
                                    <p class="mb-0 desc">تم انشاء الفاتورة : <span style="color: #0162e8;">{{ $notification->data['invoiceName'] }}</span></p>
                                    <p class="time mb-0 text-left float-right mr-2 mt-2">مند {{ $formattedDiff }} </p>
                                </div>
                            </a>
                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left">وضع علامة على الكل كمقروء</span>
                            </div>
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">لديك 0 الرسائل غير مقروءة</p>
                        </div>
                ...
                <div class="nav-item full-screen fullscreen-button">
                    <a class="new nav-link full-screen-link" href="#" style="display: flex;align-items: center; justify-content: center;">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{ route('notifications.index') }}"><i class="bx bx-envelope"></i>الإشعارات</a>
