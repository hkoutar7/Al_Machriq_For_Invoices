...
<div class="main-error-wrapper  page page-h ">
    ...
    <h2>عفوًا. الصفحة التي كنت تبحث عنها غير موجودة.</h2>
    <h6>قد يكون قد تم كتابة العنوان بشكل خاطئ أو ربما تم نقل الصفحة.</h6>
    <a class="btn btn-outline-danger" href="{{ route('dashboard') }}">العودة إلى الصفحة الرئيسية</a>
</div>
<!-- /Main-error-wrapper -->
@endsection
@section('js')
